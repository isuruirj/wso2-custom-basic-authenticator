...
package com.sample.custom.authenticator.basic.internal;

import com.sample.custom.authenticator.basic.CustomBasicAuthenticator;
...
/**
 * @scr.component name="com.sample.custom.authenticator.basic.component" immediate="true"
...
public class CustomBasicAuthenticatorServiceComponent {
    ...
    protected void activate(ComponentContext ctxt) {
        try {
            ...
            log.error("CustomBasicAuthenticator bundle activation Failed", e);
        }
    }
